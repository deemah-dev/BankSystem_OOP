...
class clsMainScreen : public clsScreen {
	static short _ReadMainMenuChoice() {
		...
		short Choice = clsInputValidate::ReadIntNumberBetween(1, 9, "\t\t\t\t\tPlease enter a number Between 1 to 9 : ");
		return Choice;
	}
	enum enMainMenu { ShowClients = 1, AddClient = 2, DeleteClient = 3, UpdateClient = 4, FindClient = 5, Transactions = 6, ManageUsers = 7,LoginRegister = 8, Logout = 9 };
...
public:
	...
	static void ShowMainScreen() {
		...
		cout << clsUtility::Tab(5) << "[9] Logout\n";
		cout << clsUtility::Tab(5) << "===========================================\n";
